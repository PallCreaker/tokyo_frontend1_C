...
questions = Question.create([
  # {user_id: 1, category_id: 20, content: '入室探知機', status: 0},
  # {user_id: 2, category_id: 14, content: '古文の勉強', status: 0},
  # {user_id: 3, category_id: 21, content: '力学', status: 0},
  ...
  # {user_id: 7, category_id: 24, content: '', status: 0},
  # {user_id: 8, category_id: 25, content: '', status: 0},
  # {user_id: 9, category_id: 13, content: '', status: 0},
  # {user_id: 10, category_id: 17, content: '', status: 0},
  # {user_id: 11, category_id: 18, content: '', status: 0},
  # {user_id: 12, category_id: 12, content: '', status: 0},
  # {user_id: 13, category_id: 24, content: '', status: 0},
  # {user_id: 14, category_id: 10, content: '', status: 0},
